...
- Change checkboxes (which usually allow multiple selections) into radio buttons (which only allow one selection)
- Added small animations and quality of life improvements
